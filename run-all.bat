...
start "ms-feedback" mvn -f ms-feedback spring-boot:run
start "ms-cafeteria" mvn -f ms-cafeteria spring-boot:run
start "ms-merchantdising" mvn -f ms-merchantdising spring-boot:run
