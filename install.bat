...
rmdir /s /q ms-ticketing\target
rmdir /s /q ms-reserva\target
rmdir /s /q ms-pagos\target
rmdir /s /q ms-suscripciones\target
rmdir /s /q ms-catalogo\target
rmdir /s /q ms-funciones\target
rmdir /s /q ms-gestion\target
rmdir /s /q ms-notificaciones\target
rmdir /s /q ms-feedback\target
rmdir /s /q ms-cafeteria\target
rmdir /s /q ms-merchantdising\target
rmdir /s /q ms-personal\target
rmdir /s /q ms-informes\target
rmdir /s /q ms-promociones\target
